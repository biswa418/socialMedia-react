...
const Settings = () => {
  ...
  return (
    <form
      className="w-5/6 rounded-md mt-40 md:w-1/3 p-5 mx-auto flex flex-col bg-white md:flex-row"
      ...
      <div className="md:px-8 w-full flex flex-col items-center justify-center">
        ...
        <div className="w-full mt-2">
          ...
          {!editMode ? (
            ...
            <input
              className="w-full text-slate-600 outline-gray-300 text-lg p-2 rounded-md"
              type="text"
              value={name}
        ...
        <div className="w-full mt-2 flex flex-col items-end">
          {editMode ? (
            <>
              <button
                className="bg-purple-500 my-4 w-full mt-2 text-white p-2 rounded-md"
                disabled={updateIn}
              >
              ...
              <button
                className="text-purple-500 mb-4  p-2 rounded-md"
                disabled={updateIn}
