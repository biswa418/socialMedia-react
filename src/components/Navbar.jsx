...
const Navbar = () => {
  ...
  return (
    <nav className="flex bg-white p-3 py-5 items-center justify-between">
      ...
      <div className="rightDiv flex text-slate-900 font-bold text-base">
        {auth.user && (
          <button
            ...
            className="user p-2 rounded-full  hover:bg-slate-200"
          >
              ...
              <>
                {showMenu && (
                  <motion.div
                    ...
                    className="absolute flex flex-col justify-center items-center w-1/4 right-10 top-24 p-8 rounded-lg bg-white text-slate-400 text-sm space-y-2"
                  >
                    <Link
                      to="/settings"
