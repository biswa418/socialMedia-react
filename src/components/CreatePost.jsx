...
const CreatePost = () => {
  ...
  return (
    <div className="mt-[20px] flex flex-col bg-purple-100 p-4 rounded-md">
      <textarea
        className="w-full resize-none placeholder:text-gray-300 bg-white rounded-md border-purple-500 focus-visible:outline focus-visible:outline-purple-500 p-4"
        value={post}
        rows={5}
